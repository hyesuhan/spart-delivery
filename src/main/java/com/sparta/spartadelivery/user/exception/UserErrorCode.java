...
public enum UserErrorCode implements BaseErrorCode {
    ...
    // 사용자 탈퇴 API 관련 에러 코드
    USER_DELETE_ACCESS_DENIED(HttpStatus.FORBIDDEN, "사용자 탈퇴 권한이 없습니다."),
    MANAGER_DELETE_TARGET_ACCESS_DENIED(HttpStatus.FORBIDDEN, "MANAGER는 CUSTOMER 또는 OWNER 사용자만 탈퇴 처리할 수 있습니다."),
    MASTER_DELETE_DENIED(HttpStatus.FORBIDDEN, "MASTER 계정은 탈퇴할 수 없습니다."),
    SELF_DELETE_BY_ADMIN_API_DENIED(HttpStatus.FORBIDDEN, "관리자용 사용자 탈퇴 API로 자기 자신을 탈퇴 처리할 수 없습니다."),
